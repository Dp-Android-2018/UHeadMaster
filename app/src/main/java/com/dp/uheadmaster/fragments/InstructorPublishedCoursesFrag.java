...
public class InstructorPublishedCoursesFrag extends Fragment{

    @Nullable @BindView(R.id.recycler_courses)
                    ...
                    try {
                        ...
                        if (instructorCoursesResponse.getStatusCode() == 200) {
                            ...
                            for (int i = 0; i < instructorCoursesResponse.getCourses().size(); i++) {
                                ...
                                if(instructorCoursesResponse.getCourses().get(i).getStatus().equals("published"))
                         ...
                         //   courses.clear();
                            ...
                            if(courses.isEmpty()&& !next_page.equals("")){
                                getInstructorCourses();
                            }
