...
public class InstructorDescendingOrderFragment extends Fragment {
    ...
    private ArrayList<InstructorCourse> courses4;
    ...
    public void initalizeUi(){
        ...
        adapter=new MoreCoursesAdapter(getActivity().getApplicationContext(),courses4);
                    ...
                    try {
                        ...
                        if (instructorCoursesResponse.getStatusCode() == 200) {
                            ...
                            for (int i = 0; i < instructorCoursesResponse.getCourses().size(); i++) {
                                ...
                                courses4.add(instructorCoursesResponse.getCourses().get(i));
                            }
                            if(courses4.size()==0){
                            ...
                            if (!courses4.isEmpty()) {
                                Collections.sort(courses4, new Comparator<InstructorCourse>() {
                                    @Override
