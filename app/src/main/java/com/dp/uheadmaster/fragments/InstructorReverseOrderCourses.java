...
public class InstructorReverseOrderCourses extends Fragment {
    ...
    private ArrayList<InstructorCourse> courses3;
    ...
    public void initalizeUi(){
        ...
        adapter=new MoreCoursesAdapter(getActivity().getApplicationContext(),courses3);
                    ...
                    try {
                        ...
                        if (instructorCoursesResponse.getStatusCode() == 200) {
                            ...
                            for (int i = 0; i < instructorCoursesResponse.getCourses().size(); i++) {
                                ...
                                courses3.add(instructorCoursesResponse.getCourses().get(i));
                            }
                           ...
                           final Collator collator = Collator.getInstance(Locale.US);
                            if (!courses3.isEmpty()) {
                                Collections.sort(courses3, new Comparator<InstructorCourse>() {
                                    @Override
